...
class Post(BaseModel):
    ...
    users_who_like = relationship("User", secondary="like_table", back_populates="liked_posts")
    users_who_dislike = relationship("User", secondary="dislike_table", back_populates="disliked_posts")
